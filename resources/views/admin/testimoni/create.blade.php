...
<div class="container-fluid max-w-4xl">
    <div class="d-flex align-items-center mb-4 gap-3">
        ...
        <h4 class="fw-bold mb-0">Tambah Testimoni Baru</h4>
    </div>
                ...
                <div class="row g-4">
                    <div class="col-md-8">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg rounded-3 @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Contoh: Ahmad Abdullah">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="role" class="form-control rounded-3 @error('role') is-invalid @enderror" value="{{ old('role') }}" placeholder="Contoh: Alumni 2024 / Orang Tua Wali">
                            @error('role') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold small text-uppercase text-muted">Isi Testimoni</label>
                            <textarea name="content" class="form-control rounded-3 @error('content') is-invalid @enderror" rows="4" required placeholder="Tuliskan testimoni di sini...">{{ old('content') }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="mb-4">
                            <label class="form-label fw-bold small text-uppercase text-muted">Upload Foto Penulis</label>
                            <input type="file" name="image" class="form-control rounded-3 @error('image') is-invalid @enderror" accept="image/*">
                            @error('image') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            <div class="form-text mt-2 small">Foto akan dipotong bentuk lingkaran. Format: JPG, PNG maksimal 2MB.</div>
                        </div>
