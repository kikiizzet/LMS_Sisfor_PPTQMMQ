    ...
    <div class="container-lg mt-4 mb-5">
        <div class="mb-4">
            ...
            <h1 class="h3 fw-bold mt-2">
                <i class="fas fa-book me-2" style="color: #7c3aed;"></i>Tambah Mata Pelajaran Baru
            </h1>
        </div>
                ...
                <form action="{{ route('admin.mapel.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode" class="form-control" value="{{ old('kode') }}" placeholder="Contoh: MTK01">
                            </div>
                        </div>
                        <div class="col-md-8 mb-3">
                            <div class="form-group">
                                <label>Nama Mata Pelajaran <span class="text-danger">*</span></label>
                                <input type="text" name="nama_mapel" class="form-control" value="{{ old('nama_mapel') }}" required placeholder="Contoh: Matematika">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label>Induk</label>
                                <input type="text" name="induk" class="form-control" value="{{ old('induk') }}" placeholder="Induk mata pelajaran">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label>Kelompok</label>
                                <input type="text" name="kelompok" class="form-control" value="{{ old('kelompok') }}" placeholder="Contoh: A / B / C">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label>Jurusan</label>
                                <input type="text" name="jurusan" class="form-control" value="{{ old('jurusan') }}" placeholder="Contoh: IPA / IPS / Umum">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label>JJM (Jam Jumlah Mengajar)</label>
                                <input type="number" name="jjm" class="form-control" value="{{ old('jjm') }}" placeholder="0" min="0">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <select name="kurikulum" class="form-select">
                                    ...
                                    <option value="KMI" {{ old('kurikulum') == 'KMI' ? 'selected' : '' }}>KMI</option>
                                    <option value="Diniyah" {{ old('kurikulum') == 'Diniyah' ? 'selected' : '' }}>Diniyah</option>
                                </select>
                            </div>
                        </div>
                    </div>
