    ...
    <div class="container-lg mt-4 mb-5">
        ...
        <div class="mb-4">
            ...
            <h1 class="h3 fw-bold mt-2">
                <i class="fas fa-user-tie me-2"></i>{{ isset($guru) ? 'Edit Data Guru' : 'Tambah Guru Baru' }}
            </h1>
        </div>
        ...
        <div class="card card-main">
            <div class="card-body p-4">
                <form action="{{ isset($guru) ? route('admin.guru.update', $guru) : route('admin.guru.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($guru))
                        @method('PUT')
                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center mb-4">
                            <div class="form-group">
                                ...
                                @if(isset($guru) && $guru->foto)
                                    <img src="{{ asset('storage/' . $guru->foto) }}" alt="{{ isset($guru) ? $guru->nama : 'Guru' }}" class="photo-preview mb-3" id="photoPreview">
                                @else
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" value="{{ old('nama', isset($guru) ? $guru->nama : '') }}" required>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label>NIK</label>
                                        <input type="text" name="nik" class="form-control" value="{{ old('nik', isset($guru) ? $guru->nik : '') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label>NUPTK</label>
                                        <input type="text" name="nuptk" class="form-control" value="{{ old('nuptk', isset($guru) ? $guru->nuptk : '') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="jenis_kelamin" class="form-select">
                                    ...
                                    <option value="L" {{ old('jenis_kelamin', isset($guru) ? $guru->jenis_kelamin : '') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="P" {{ old('jenis_kelamin', isset($guru) ? $guru->jenis_kelamin : '') == 'P' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tempat_lahir" class="form-control" value="{{ old('tempat_lahir', isset($guru) ? $guru->tempat_lahir : '') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_lahir" class="form-control" value="{{ old('tanggal_lahir', isset($guru) && $guru->tanggal_lahir ? $guru->tanggal_lahir->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="pendidikan" class="form-control" placeholder="Contoh: S1, S2, S3" value="{{ old('pendidikan', isset($guru) ? $guru->pendidikan : '') }}">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="wali_kelas" class="form-control" value="{{ old('wali_kelas', isset($guru) ? $guru->wali_kelas : '') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="jtm" class="form-control" value="{{ old('jtm', isset($guru) ? $guru->jtm : '') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="hidden" name="ttd" id="ttdInput" value="{{ old('ttd', isset($guru) ? $guru->ttd : '') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary btn-submit">
                            <i class="fas fa-save me-2"></i>{{ isset($guru) ? 'Update' : 'Simpan' }}
                        </button>
